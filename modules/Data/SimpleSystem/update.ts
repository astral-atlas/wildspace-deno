import { channel, m } from "../ServiceCommon/deps.ts";
...
export const createUpdateChannelDefinition = <T extends SimpleSystemType>(
  definition: SimpleSystemDefinition<T>
): channel.ChannelDefinition<{
  Incoming: ChangeEvent<T>,
  Outgoing: ChangeEvent<T>
}> => {
  return {
    incoming: createChangeEventModel(definition),
    outgoing: createChangeEventModel(definition),
  }
}