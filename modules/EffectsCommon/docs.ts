...
import { act, actThree, componentDoc, three } from "./deps.ts";

// @deno-types="vite-text"
import readme from "./readme.md?raw";
import { OrbitSceneCanvas, Helper } from "../ThreeCommonDoc/mod.ts";
...
const Child: act.Component<{ distance: number, lines?: boolean, key?: string }> = ({ distance, lines }) => {
